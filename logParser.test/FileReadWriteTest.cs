namespace logParser.test {
    ...
    public class FileReadWriteTest : IFileReadWriteTest
    {
        [Fact]
        public void TestAddHeaderToDestination()
        {
            new FileWriter(@"..\..\..\SampleInputOutput\Input\logs", @"..\..\..\SampleInputOutput\Output\checkHeader.csv").AddHeaderToDestination('|');
        ...
        {
            Assert.True(@"..\..\..\SampleInputOutput\Output\log.csv".Equals(new FileWriter(@"..\..\..\SampleInputOutput\Input\logs", dest).Destination));
        }
        ...
        {
            Assert.Equal(15, new FileWriter(@"..\..\..\SampleInputOutput\Input\logs", @"..\..\..\SampleInputOutput\Input\old.csv").GetLastLogIdFromOldCSVFile());
        }

        [Fact]
        public void TestIsSourceValid()
        {
            Assert.True(new FileWriter { Source = @"..\..\..\SampleInputOutput\Input\logs" }.IsSourceValid());
        }

        [Fact]
        public void TestReadAllLines()
        {
            Assert.Equal(16, new FileWriter().ReadAllLines(@"..\..\..\SampleInputOutput\Input\old.csv").Count);
        }
        ...
        public void TestWriteToFileAllLine()
        {
            ...
            lines.Add("second");
            lines.Add("third");
            new FileWriter(@"..\..\..\SampleInputOutput\Input\logs", @"..\..\..\SampleInputOutput\Output\multiLineWrite.csv").WriteToFile(lines);
        ...
        public void TestWriteToFileSingleLine()
        {
            ...
            new FileWriter(@"..\..\..\SampleInputOutput\Input\logs", @"..\..\..\SampleInputOutput\Output\singleLineWrite.csv").WriteToFile(line);
